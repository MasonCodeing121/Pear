const apps = {
    "Web Apps": [
      ...
      {
        name: "Movies and TV",
        imageUrl: "assets/img/123-movies.jpg",
        url: "openGame('https://ww4.fmovies.co/24/')"
      },
      {
        name: "Movies and TV (2)",
        imageUrl: "assets/img/movies.png",
        url: "openGame('https://heartive-us4.pages.dev/')"
      },
      {
      ...
      {
        name: "Emulator Online",
        imageUrl: "assets/img/emulator.jpeg",
        url: "openGame('https://emulatoronline.com/')"
      },
      {
        name: "KBH Games",
